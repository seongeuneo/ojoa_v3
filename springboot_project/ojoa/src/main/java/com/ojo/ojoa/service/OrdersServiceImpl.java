...
// 		List<OrdersDTO> result = ordersRepository.findAllOrdersList();  
		return result;
	}
...
//	// orderNumber : 조회할 특정 주문번호 (null일경우 제한없음)
//	@Override
//	public List<OrdersResDTO.OrderNonMemberDTO> selectOrderList(String loginID, String startDate, String endDate,
//			String orderNumber) {
//		LocalDateTime tmp_startDate = null;
//		LocalDateTime tmp_endDate = null;
//		if (startDate != null) {
...
//		}
//
//		List<OrdersResDTO.OrderNonMemberDTO> result = ordersRepository.findOrderList(loginID, tmp_startDate,
//				tmp_endDate, orderNumber);
//		return result;
//	}
//
//} // class
