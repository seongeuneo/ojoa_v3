...
public class OrdersRestController {
    ...
    // API 엔드포인트로 payNow 작업을 위한 메서드 추가
    @PostMapping("/orders/saveOrders")
    public ResponseEntity<String> saveOrders(@RequestBody OrdersDTO ordersDTO) {
        try {
            ...
            log.error("Error while processing payNow API: " + e.toString());
